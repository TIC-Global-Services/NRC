...
// BlogProfile Component - Exact replica of the image design
            ...
            <Container disableYSpacing>
                ...
                <div className="flex md:flex-row flex-col max-w-3xl mx-auto md:items-center justify-between mb-12 ">
                    <div className="flex md:flex-row flex-col md:items-center gap-4">
                        <Image
                            src={typeof blog.userImage === 'string' ? blog.userImage : blog.userImage.src}
                            alt={blog.userName}
                            width={56}
                            height={56}
                        ...
                        />
                        <div>
                            <p className="font-bold text-base tracking-[5%] mb-2">{blog.userName}</p>
                    ...
                    {/* Social Icons */}
                    <div className="flex mt-4 md:mt-0 w-36 border border-[#EAEAEA] bg-white rounded-[4px]" style={{
                ...
                <div className="prose prose-lg">
                    {blog.sections?.map((section: any, index: any) => {
                        if (section.type === 'text') {
                            return (
                                <p key={index} className=" max-w-3xl mx-auto leading-[175%] md:leading-relaxed mb-6 text-base">
                                    {section.content}
                                </p>
                            );
                        }
                        ...
                        if (section.type === 'heading') {
                            return (
                                <h2 key={index} className="md:text-[32px] text-[24px] leading-[160%] font-bold max-w-3xl mx-auto mt-6 mb-4">
                                    {section.content}
                                </h2>
                            );
                        }
                ...
                {blog.tags && blog.tags.length > 0 && (
                    <div className=" pt-8 flex flex-row md:items-center gap-2 text-base tracking-[3%] leading-[100%] font-normal  max-w-3xl mx-auto ">
                        <p className="">Tags:</p>
