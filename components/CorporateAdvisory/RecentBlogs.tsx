  ...
  return (
    <Container disableYSpacing className="md:pt-[87px] md:pb-48 pt-12">
      <div>
        ...
        {/* Blog Grid */}
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-[19px] md:h-[392px]">
          {/* Blog Posts */}
          ...
          {/* Explore More Card */}
          <div className="bg-primary md:block hidden  rounded-2xl p-8 text-white relative overflow-hidden h-full">
