...
const TwoDistinctComponent: React.FC<TwoDistinctProps> = ({
  ...
  return (
    <Container
      disableYSpacing
      className={`w-full mx-auto mb-32 md:pt-12 lg:pt-0 lg:mb-40  ${className}`}
    >
      {/* desktop */}
      <FlexibleHeading
      ...
      <div className="grid lg:grid-cols-2 lg:gap-x-5 gap-y-4 lg:gap-y-0">
        ...
        <div className="relative rounded-2xl h-[373px] lg:h-auto">
          <Image
            src={Row1Col1}
            alt="Aurum_SME_Fund_I"
            className="rounded-2xl h-full"
          />
          <div className="absolute bottom-0 left-0 text-white pl-6 pb-6">
            <h1 className="md:text-2xl md:leading-9 text-[20px] leading-7 font-normal mb-2 md:mb-0">
              Aurum SME Fund I (Category I AIF) -<br />
              Closed to Investors
            </h1>
            <p className="md:text-base text-sm leading-4 md:leading-6 font-normal text-[#C4BEBE]">
              A close-ended fund focused on early-stage companies in sunrise
              sectors.
            </p>
          </div>
        </div>
        ...
        <div className="bg-[#F3F3F5]  rounded-2xl px-6 py-6 flex flex-col justify-between items-start h-[506px] md:h-auto">
          ...
          <ul className="text-base leading-8 font-normal space-y-2 text-[#484848]">
            ...
            <li className="flex items-center gap-2">
              <span className="w-[5px] h-[5px] bg-[#484848] rounded-full"></span>
              <span>
                Targeting high-growth potential with a focus on profitability
                and scalability
              </span>
            </li>
            <li className="flex items-center gap-2">
          ...
          <div className="flex flex-col md:flex-row gap-x-4 gap-y-2 mt-3 md:justify-center md:items-center">
            <AnimatedButton label="Download Brochure" variant="default" />
            <AnimatedButton
      ...
      {/* Row3 */}
      <div
        className={`relative rounded-2xl overflow-hidden h-[373px] lg:h-auto ${
          showPortfolio ? ` mt-0` : ` mt-8`
        }`}
      >
        <Image src={Row3} alt="Aurum_SME_Fund_I" className="h-full" />
        <div className="absolute bottom-0 left-0 text-white pl-6 pb-6">
          <h1 className="md:text-2xl md:leading-9 text-[20px] leading-7 font-normal w-[85%] md:w-auto mb-2 md:mb-0">
            Aurum Rising India Fund (Category II AIF) - Green Shoe Open
          </h1>
          <p className="md:text-base text-sm leading-4 md:leading-6 font-normal text-[#C4BEBE] mb-3">
            An open-ended fund investing in unlisted and listed companies with
            medium to late-stage growth.
          </p>
          <AnimatedButton label="Download Brochure" variant="default" />
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 gap-y-5">
          ...
          <div className="bg-[#F3F3F5] rounded-2xl px-6 pt-8 h-[538px] overflow-hidden">
            ...
            <ul className="list-disc list-outside ml-5 text-base font-normal md:space-y-2 text-[#484848] leading-8 marker:text-[#484848]">
              <li className="pl-2">
                Primary Allocation: Unlisted medium to late-stage, pre-IPO,
                high-growth companies
              </li>
              <li className="pl-2">
                SME Board / PIPE Deals: Identify companies early in their growth
                cycle
              </li>
              <li className="pl-2">
                Opportunistic Special Situations: Seeking opportunities that
                offer disproportionate value unlocking
              </li>
            </ul>
          ...
          <div className="bg-[#E1E1ED] rounded-2xl px-6 pt-8 lg:h-[285px] relative">
            ...
            <ul className="list-disc list-outside ml-5 text-base font-normal md:space-y-2 text-[#484848] leading-8 marker:text-[#484848] pr-4 pb-8 lg:pb-0">
              <li className="pl-2">
                Capitalize on India&apos;s high-growth potential in the
                manufacturing sector
              </li>
              <li className="pl-2">
                Access to unique, early-stage growth companies.
              </li>
              <li className="pl-2">
                Benefit from the government&apos;s initiatives to support
                economic growth.
              </li>
              <li className="pl-2">
                Leverage NRC&apos;s proven track record in small-cap investing.
              </li>
            </ul>
          ...
          <div className="px-8 pb-8 rounded-2xl bg-[#C5C3FE] lg:h-[373px] flex flex-col justify-between">
            ...
            <div className="mt-2 lg:mt-0">
              ...
              <ul className="list-disc list-outside ml-5 text-base font-normal lg:space-y-1 text-[#484848] leading-8">
                ...
                <li className="pl-2">
                  Investor Profile: UHNIs & Family Offices
                </li>
              </ul>
            </div>
          </div>
