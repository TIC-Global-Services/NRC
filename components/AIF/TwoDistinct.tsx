...
const TwoDistinctComponent: React.FC<TwoDistinctProps> = ({
  ...
  return (
    <Container disableYSpacing className={`w-full mx-auto mb-32 md:mb-40  ${className}`}>
      ...
      <div className="grid md:grid-cols-2 md:gap-x-5 gap-y-4 md:gap-y-0">

        {/* Row1Col1 */}
        <div className="relative rounded-2xl h-[373px] md:h-auto">
      ...
      {/* Row3 */}
      <div className={`relative rounded-2xl overflow-hidden h-[373px] md:h-auto ${showPortfolio ? ` mt-0` : ` mt-8`}`}>
      ...
      {/* Row4 */}
      <div className="grid md:grid-cols-2 mt-6 md:mt-8 gap-x-5 ">
        <div className="grid grid-cols-1 gap-y-5">
          ...
          {/* row2col1 */}
          <div className="bg-[#E1E1ED] rounded-2xl px-6 pt-8 md:h-[285px] relative">
            <h1 className="text-2xl leading-9 font-normal mb-2 md:mb-0">
              Why <span className="text-primary">Invest</span>
            </h1>
            <ul className="list-disc list-outside ml-5 text-base font-normal md:space-y-2 text-[#484848] leading-8 marker:text-[#484848] pr-4 pb-8 md:pb-0">
            ...
            <svg width="96" height="154" className="absolute bottom-6 right-7 hidden md:block" viewBox="0 0 96 154" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="grid grid-cols-1 gap-y-5 mt-5 md:mt-0">
          {/* row1col2 */}
          <div className="px-8 pb-8 rounded-2xl bg-[#C5C3FE] md:h-[373px] flex flex-col justify-between">
            ...
            <div className="mt-2 md:mt-0">
              ...
              <ul className="list-disc list-outside ml-5 text-base font-normal md:space-y-1 text-[#484848] leading-8">
          ...
          {/* row2col2 */}
          <div className="md:h-[450px] md:block hidden">
