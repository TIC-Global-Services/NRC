      ...
      <div className=" mx-auto">
        <div className="grid lg:grid-cols-[0.45fr_0.55fr] md:items-center items-start">
                ...
                <div className="space-y-3">
                  {fundOptions.map((fund, index) => (
                    <button
                      ...
                      className={`w-full cursor-pointer text-left px-4 py-3 rounded-lg leading-[33px] text-lg transition-all duration-300 ${selectedFund === fund
          ...
          <div className="mt-4 md:mt-12 mb-12 md:mb-0">
            ...
            <div className=" md:hidden md:mb-6 mt-4">
              <div className="space-y-3">
                {fundOptions.map((fund, index) => (
                  <button
                    key={fund}
