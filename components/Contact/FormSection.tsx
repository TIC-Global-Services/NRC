...
const FormSection = () => {
  return (
    <Container disableYSpacing className="grid grid-cols-1 lg:grid-cols-2 gap-20 lg:gap-0 bg-[#F6F9FC] lg:mt-32 lg:mb-36 mt-[70px]">
      <div
        className="flex flex-col justify-between items-start gap-6 lg:gap-0"
      >
        {/* Heading */}
