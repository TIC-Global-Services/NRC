    ...
    <div className="relative bg-white rounded-2xl shadow-[0_4px_20px_rgba(0,0,0,0.05)] md:px-10 px-5 pt-6 pb-6 transition-all duration-300 hover:shadow-[0_6px_25px_rgba(0,0,0,0.08)]">
      ...
      <div ref={containerRef} className="relative w-full">
        ...
        >
          ...
          {/* Portfolio Line with gradient + glow */}
          <path
        ...
        {hoveredPoint && (
          <div
            className="absolute bg-white shadow-lg rounded-lg px-3 py-2 border border-gray-100 pointer-events-none text-xs transition-all duration-150"
            style={{
      ...
      <div className="flex flex-wrap justify-center md:justify-between items-center gap-4">
        <div className="flex items-center gap-2">
          ...
          <p className="text-sm text-gray-700 font-medium">S&P BSE 500 Index</p>
        </div>
        <div className="flex items-center gap-2">
      ...
      <div className="mt-5 text-center">
        ...
        <p className="text-[15px] font-bold text-primary">
          Aurum Multiplier: {portfolioCAGR.toFixed(2)}% | Benchmark:{" "}
